	...
	<section class="sidebar"> 
		...
		<ul class="sidebar-menu"> 
			...
			<li class="treeview <?= ($uri_1 == 'master') ? 'active' : '' ?> "> 
				<a href="#"> 
					<i class="fa fa-money text-yellow"></i> <span>Master Data</span> <i class="fa fa-angle-right pull-right text-yellow"></i> 
				</a> 
			...
			<li class="treeview <?= ($uri_1 == 'transaksi') ? 'active' : '' ?> "> 
				<a href="#"> 
					<i class="fa fa-money text-yellow"></i> <span>Transaksi</span> <i class="fa fa-angle-right pull-right text-yellow"></i> 
				</a> 
				<ul class="treeview-menu"> 
