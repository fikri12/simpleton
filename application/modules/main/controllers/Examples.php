...
class Examples extends CI_Controller {
	...
	public function employees_management()
	{
			...
			//Config Halaman
			$output->judul_besar = 'Employees';
			$output->judul_kecil = 'Manage Employees';
			$output->m_employees_management = TRUE;
	...
	public function customers_management()
	{
			...
			//Config Halaman
			$output->judul_besar = 'Customer';
			$output->judul_kecil = 'Manage Customer';
			$output->m_customers_management = TRUE;
	...
	public function film_management()
	{
		...
		//Config Halaman
		$output->judul_besar = 'Film';
		$output->judul_kecil = 'Manage Film';
		$output->m_film_management = TRUE;
	...
	function multigrids()
	{
		...
		//Config Halaman
		$judul_besar = 'Multigrids';
		$judul_kecil = 'Test Multigrids';
		$m_multigrids = TRUE;
